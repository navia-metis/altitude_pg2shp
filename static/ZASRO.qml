...
<qgis version="2.14.3-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="NRO">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CODE_PM"/>
  ...
  <displayfield>NOM_PM</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <annotationform>../../../01_ZA_NROPM/00_TEMP</annotationform>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions/>
  <editform>../../../01_ZA_NROPM/00_TEMP</editform>
  <editforminit/>
